 ...
 * Global Error Page
 * 
 * Catches errors in the root layout. This is a fallback for errors that
 * occur outside of the normal error boundary (e.g., in the root layout itself).
 * 
 * Note: This must be a client component and should not include the root layout.
 */
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body>
        <div className="min-h-screen bg-gradient-to-br from-white via-red-50/30 to-orange-50/20 flex items-center justify-center px-4 py-12">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-base text-gray-500 mb-8">
              We're working to fix the issue. Please try refreshing the page or contact support.
            </p>
