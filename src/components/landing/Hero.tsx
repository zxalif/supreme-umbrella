  ...
  return (
    <section className="relative bg-gradient-to-br from-white via-primary-50/30 to-secondary-50/20 py-6 lg:py-8 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div 
          className="absolute top-20 left-10 w-72 h-72 rounded-full animate-blob"
          style={{ 
        ...
        ></div>
        <div 
          className="absolute top-40 right-10 w-72 h-72 rounded-full animate-blob animation-delay-2000"
          style={{ 
        ...
        ></div>
        <div 
          className="absolute -bottom-8 left-1/2 w-72 h-72 rounded-full animate-blob animation-delay-4000"
          style={{ 
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`text-center lg:text-left transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              <span className={`inline-block transition-all duration-700 delay-100 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                Find Freelance Opportunities on
              </span>
              <span className={`inline-block transition-all duration-700 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <span className={`block transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                <span className="text-secondary-600 inline-block">Never Miss a Lead Again 😴</span>
              </span>
            </h1>

            {/* Subheadline - More Compelling with Animation */}
            <p className={`text-xl md:text-2xl text-gray-600 mb-4 leading-relaxed transition-all duration-700 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className={`text-lg text-gray-700 mb-8 transition-all duration-700 delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              AI-powered lead generation from Reddit's freelance communities.
            </p>

            {/* Trust Indicators with Animation */}
            <div className={`flex flex-col sm:flex-row gap-6 mb-10 justify-center lg:justify-start transition-all duration-700 delay-900 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8 transition-all duration-700 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <Link
                href="/register"
            ...
            <div className={`mt-12 pt-8 border-t border-gray-200 transition-all duration-700 delay-1200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className={`relative lg:block hidden transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
            <div className="relative">
              ...
              <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 p-4">
                <div className="space-y-3">
                  ...
                  <div className={`border border-gray-200 rounded-lg p-4 hover:border-primary-300 transition-all duration-500 delay-700 hover:shadow-md ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  ...
                  <div className={`border border-gray-200 rounded-lg p-4 hover:border-primary-300 transition-all duration-500 delay-800 hover:shadow-md ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                    <div className="flex items-start justify-between mb-2">
                  ...
                  <div className={`border border-gray-200 rounded-lg p-4 hover:border-primary-300 transition-all duration-500 delay-900 hover:shadow-md ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                    <div className="flex items-start justify-between mb-2">
              ...
              <div className={`absolute -top-4 -right-4 bg-white rounded-lg shadow-lg p-4 border border-gray-200 transition-all duration-700 delay-1000 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-0'}`}>
